...
public class UpdateDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 620, -1, 30));

        jLabel1.setFont(new java.awt.Font("Tw Cen MT", 0, 48)); // NOI18N
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Update & Delete Student/employee_1256668.png"))); // NOI18N
        jLabel1.setText("Update & Delete");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 410, 70));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 330, -1, 50));

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("Mobile");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 410, -1, 30));

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("Email");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 480, -1, 30));

        jLabel7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel7.setText("ID");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, -1, 30));

        jLabel8.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel8.setText("Name");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, -1, 30));

        jLabel9.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel9.setText("Gender");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 550, -1, 30));

        payTxt.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        jPanel1.add(payTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 620, 130, 30));
        ...
        jPanel1.add(nameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 250, 30));

        ageTxt.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        jPanel1.add(ageTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 280, 90, 30));

        addressTxt.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        jPanel1.add(addressTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 250, 30));

        mobileTxt.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        jPanel1.add(mobileTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 410, 250, 30));

        emailTxt.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        jPanel1.add(emailTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 480, 250, 30));
        ...
        jPanel1.add(genderCmb, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 550, 120, 30));
        ...
        jPanel1.add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 700, 110, 50));
        ...
        jPanel1.add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 700, 110, 50));
        jPanel1.add(idsearchTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 40, 30));

        searchBtn.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        searchBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Update & Delete Student/search.png"))); // NOI18N
        ...
        jPanel1.add(searchBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 100, 40));
        ...
        jPanel1.add(resetBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 700, 110, 50));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 520, 790));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Update & Delete Student/ucd-students-in-hall-mjvp9q9oud10s9ob.jpg"))); // NOI18N
        jLabel10.setText("jLabel10");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1530, 830));
